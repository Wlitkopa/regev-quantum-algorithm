...
def draw_plot(N_list, d_qd_list, type_of_test_list, meas_R_list):
    ...
    colors = [["red", "orange"], ["blue", "gray"], ["yellow", "yellowgreen"], ["navy", "purple"]]
        ...
        # for type_of_test in type_of_test_list:
            ...
            # for meas_R in meas_R_list:
                ...
                plt.plot(N_list[:len(effectiveness_nontrivial_list)], effectiveness_nontrivial_list,
                         label=f"Unity modulo N non-trivial square root, {output_register_measuring} output registry measuring, {R_type} R",
            ...
            # ALL OUTPUT REGS CONFIGURATIONS AND ALL R PARAMETER VALUES ONE TEST TYPE
            # plt.savefig(f"../../../images/plots/effectiveness_gauss/effectiveness_{d}_{qd}_test_type_{type_of_test}.png")
            # print(f"CREATED PLOT: images/plots/effectiveness_gauss/effectiveness_{d}_{qd}_test_type_{type_of_test}.png")

            plt.savefig(f"../../../images/plots/effectiveness_gauss/effectiveness_{d}_{qd}_test_type_{type_of_test}.svg", format="svg")
            print(f"CREATED PLOT: images/plots/effectiveness_gauss/effectiveness_{d}_{qd}_test_type_{type_of_test}.svg")
